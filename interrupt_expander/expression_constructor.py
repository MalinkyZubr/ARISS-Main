...
if __name__ == "__main__":
    print(parse_output(process_truth_table(load_truth_csv(r"/home/malinkyzubr/Desktop/ARISS-Main/interrupt_expander/TRUTH_TABLE.csv"), ExpressionType.POS), ExpressionType.POS))
