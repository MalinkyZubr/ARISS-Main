...
class PlutoAMTransmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PlutoAMTransmit")
        ...
        self.soapy_plutosdr_sink_0.set_bandwidth(0, 100000)
        self.soapy_plutosdr_sink_0.set_frequency(0, 100000000)
        ...
        self.blocks_multiply_const_vxx_0.set_block_alias("Modulation Index")
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(40000, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_const_source_x_0 = analog.sig_source_c(0, analog.GR_CONST_WAVE, 0, 0, 1)
        self.analog_const_source_x_0.set_block_alias("DC Shift")
...
def main(top_block_cls=PlutoAMTransmit, options=None):
