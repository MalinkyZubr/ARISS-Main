...
class PlutoNBFMTransmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PlutoNBFMTransmit")
        ...
        self.iio_pluto_sink_0.set_frequency(462562000)
        self.iio_pluto_sink_0.set_samplerate(samp_rate)
        self.iio_pluto_sink_0.set_attenuation(0, 10.0)
        self.iio_pluto_sink_0.set_filter_params('Auto', '', 0, 0)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/malinkyzubr/Downloads/Johnny B. Goode.wav', True)
...
def main(top_block_cls=PlutoNBFMTransmit, options=None):
